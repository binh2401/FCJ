...
namespace WebBanHang.Controllers
{
	...
	public class ShoppingCartController : Controller
	{
        ...
        public ShoppingCartController(ApplicationDbContext context, UserManager<ApplicationUser> userManager, IProductRepository productRepository, IVnPayService vnPayService, SnsService snsService, IConfiguration config)
		{
        ...
        public async Task<IActionResult> Checkout(Order order, string payment = "COD")
        {
            ...
            if (payment == "Thanh toán VNPay")
            {
                ...
                if (!string.IsNullOrEmpty(userEmail))
                {
                    ...
                    var body = $"<h2>Đơn hàng #{order.Id} đã được đặt thành công</h2><p>Cảm ơn bạn đã mua hàng tại shop của chúng tôi!</p>";

                    await _snsService.SendEmailAsync(subject, body);
